...
class BankingSystemImpl(BankingSystem):
    ...
    def merge_accounts(self, timestamp: int, account_id_1: str, account_id_2: str) -> bool:
        ...
        # merge account data
        self.accounts[account_id_1] = self.accounts[account_id_1] | self.accounts[account_id_2]

        # for time, balance in self.accounts[account_id_2].items():
        #     if time not in self.accounts[account_id_1]:
        #         self.accounts[account_id_1][time] = 0
        #     self.accounts[account_id_1][time] += balance
